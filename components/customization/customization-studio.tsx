...
export function CustomizationStudio({
  ...
  initialState: CustomizationState | null
  ...
  return (
    <div className="space-y-8 pb-8">
      {recovery && (
        ...
        >
          ...
          <p className="text-muted-foreground">
            ...
            appearance below, or{' '}
            <RecoveryLink
              href="/dashboard/settings?recovery=1"
      ...
      <div className="flex flex-wrap justify-between items-start gap-5">
        <div>
          <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-[.16em] text-muted-foreground mb-3">
            <Sparkles className="h-3.5 w-3.5" />A space that feels like you
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">
            Make it yours<span className="text-primary/50">.</span>
          </h1>
          <p className="text-muted-foreground mt-3 max-w-xl">
            Your identity, your atmosphere, your way of sharing.
          </p>
        </div>
        <Button variant="outline" asChild>
          <Link href="/dashboard/upload-profiles">
            Upload profiles
      ...
      <Tabs
        defaultValue={isAdmin ? 'instance' : 'personal'}
        className="space-y-7"
      >
        <TabsList>
          <TabsTrigger value="personal">My workspace</TabsTrigger>
          {isAdmin && (
            <TabsTrigger value="instance">Instance appearance</TabsTrigger>
          )}
        </TabsList>
        <TabsContent value="personal">{personal}</TabsContent>
        {isAdmin && document && state && (
          <TabsContent value="instance" className="space-y-6">
            <div className="grid lg:grid-cols-[200px_minmax(0,1fr)] gap-6 xl:gap-8">
              <nav
              ...
              >
                {sections.map((item) => (
                  <button
                    ...
                    className={cn(
                      'flex items-start gap-3 text-left rounded-xl px-4 py-3 whitespace-nowrap transition-colors',
                      section === item.id
                  ...
                  >
                    ...
                    <span>
                      ...
                      <span className="hidden lg:block text-[11px] mt-1 font-normal text-muted-foreground whitespace-normal leading-relaxed">
                        {item.description}
                      </span>
                    </span>
                  </button>
                ))}
                <div className="hidden lg:block mt-6 px-4 text-xs text-muted-foreground leading-relaxed">
                  <span className="block font-medium text-foreground mb-2">
                    Made to be shared
                  </span>
                  Appearance packs let anyone build on your design. No code
                  required.
                </div>
              </nav>
              <div className="grid xl:grid-cols-[minmax(0,1fr)_minmax(320px,.85fr)] gap-7 min-w-0">
                <Card
                  ...
                  {section === 'identity' && (
                    <>
                      <CardHeader>
                        ...
                        <CardDescription>
                          The details people see when they open one of your
                          links.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Your existing favicon and advanced CSS remain
                          available in{' '}
                          <Link
                  ...
                  {section === 'theme' && (
                    <>
                      <CardHeader>
                        ...
                        <CardDescription>
                          A matched light and dark palette, with room for your
                          own details.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                    ...
                    <>
                      ...
                      <CardContent className="space-y-5">
                        <div className="space-y-3">
                          {styleOptions.map((style) => (
                            ...
                            >
                              ...
                              {document.sharing.defaultStyle ===
                                style.value && <Check className="h-4 w-4" />}
                            </button>
                          ))}
                        </div>
                        <div>
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          ...
                          downloaded files can still contain their original
                          names. File access stays governed by visibility and
                          passwords.
                        </p>
                      </CardContent>
                    </>
                      ...
                      <CardContent className="space-y-5">
                        ...
                        <div className="rounded-xl border p-5 space-y-3">
                          ...
                          <p className="text-xs text-muted-foreground leading-relaxed">
                            ...
                            embedded logos, both palettes, surfaces and
                            share-page choices.
                          </p>
                        ...
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          Imports open as a saved draft. Review the design
                          before publishing. Packs include no accounts,
                          credentials, files, or executable code.
                        </p>
                      </CardContent>
                    </>
                  )}
            ...
            <div className="sticky bottom-4 z-20 rounded-2xl border bg-background/95 backdrop-blur-xl shadow-xl px-5 py-4 flex flex-wrap gap-4 items-center justify-between">
              <div>
      ...
      {isAdmin && !recovery && (
        <p className="text-xs text-muted-foreground">
          ...
          <RecoveryLink
            href="/dashboard/customize?recovery=1"
            className="underline underline-offset-4"
          >

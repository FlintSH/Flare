...
export default function SetupPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-background/10 to-background/50">
          ...
          <CardHeader className="text-center space-y-6">
            <div>
              ...
              <div className="text-sm text-muted-foreground mt-1.5">
                Step {step} of 3: {step === 1 && 'Create your admin account'}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: 'local' | 's3') =>
                      setSetupData({
                        ...setupData,
                        storage: { ...setupData.storage, provider: value },
                      })
                    }
                  >
            ...
            {step === 3 && (
              <div className="space-y-4">
                <Alert className="bg-background/50">
                  <InfoIcon className="h-4 w-4" />
                  <AlertDescription>
                    You can always change these settings later in the admin
                    dashboard.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={setupData.registrations.enabled ? 'true' : 'false'}
                      onValueChange={(value) =>
                        setSetupData({
                          ...setupData,
                          registrations: {
